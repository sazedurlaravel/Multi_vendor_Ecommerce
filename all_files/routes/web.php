...
Route::get('/2facheck',function(){
   return 'Hello world !';
})->middleware('two_fa');

Route::view('alex','alex');

Route::post('alex','TestController@sendalexpayment');
...
Route::group(['middleware' => ['web','switch_lang']], function () {
    ...
    Route::group(['middleware' => ['maintainence_mode']], function () {
        ...
        Route::group(['middleware' => ['auth','is_verified','two_fa','switch_lang']], function () {
            ...
            Route::get("seller/sellerdashboard/", "VenderController@dashbord")->name('seller.dboard');
