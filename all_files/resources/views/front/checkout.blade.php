...
$count = App\Cart::where('user_id',auth()->user()->id)->count();
}
else{
if(isset($value)){
$count = count($value);
                          ...
                          <div class="finaltotalbox">
                            ...
                            <b>
                              ...
                              <span id="totalprice{{ $row->id }}">
                                ...
                                @else
                                {{ sprintf("%.2f",($row->price_total+$row->shipping+$after_tax_amount)*$conversion_rate) }}
                                @endif
                              </span>
                              @endif
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-8 col-8">
                          ...
                          <span class="" id="gtotal">
                            ...
                            $secure_pay = sprintf("%.2f",$secure_pay + $handlingcharge);
