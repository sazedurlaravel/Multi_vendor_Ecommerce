...
<div class="box box-primary">
  ...
  <div class="box-body">
    ...
    <div class="box-footer">
      ...
      <a @if(env('DEMO_LOCK')==0) href="{{url('store/delete/'.$store->id)}}" @else
        title="This action is disabled in demo !" @endif type="button" class="btn btn-md btn-danger"><i
          class="fa fa-trash"></i> Delete Store </a>
    </div>
  </div>
</div>
