...
<head>
  ...
  <!-- Colorpicker -->
  <link type="text/css" rel="stylesheet" href="{{url('admin/vendor/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css')}}">
  <!-- Fontawesome -->
  ...
  @else
  <link type="text/css" rel="stylesheet" href="{{url('admin/css/rtl/bootstrap-rtl.min.css')}}">
  <link type="text/css" rel="stylesheet" href="{{url('admin/css/rtl/adminlte.min.css')}}">
  ...
  @if(isset($selected_language) && $selected_language->rtl_available == 1)
  <link type="text/css" rel="stylesheet" href="{{url('admin/css/rtl/profile.css')}}">
  <link type="text/css" rel="stylesheet" href="{{url('admin/css/rtl/rtl.css')}}">
  @endif
  <!-- TinyMCE Editor -->
