      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li id="martools"
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ Nav::isRoute('admin.push.noti.settings') }}"><a href="{{route('admin.push.noti.settings')}} "><i
        ...
        <li class="treeview {{ Nav::isRoute('systemstatus') }} {{ Nav::isRoute('admin.import.demo') }} {{ Nav::isRoute('admin.backup.settings') }}">
          <a href="#">
