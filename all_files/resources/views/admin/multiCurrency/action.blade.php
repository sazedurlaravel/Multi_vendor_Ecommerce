              ...
              <div class="form-group">
                ...
                <br>
                 <select name="position" id="position" class="form-control">
                    ...
                    <option {{ $position == 'l' ? "selected" : "" }} value="l">Left side currency icon</option>
                    <option {{ $position == 'r' ? "selected" : "" }} value="r">Right side currency icon</option>
                    <option {{ $position == 'ls' ? "selected" : "" }} value="ls">Left side with space currency icon</option>
                    <option {{ $position == 'rs' ? "selected" : "" }} value="rs">Right side with space currency icon</option>
                 </select>
              </div>
            </div>
  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
         <form method="post" action="{{route('multiCurrency.destroy',$mid)}}" class="pull-right">
           @method('delete')
           @csrf
