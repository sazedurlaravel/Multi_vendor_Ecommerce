...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    protected $fillable = [
        'name', 'email', 'password', 'role_id', 'phonecode', 'mobile', 'city_id', 'country_id', 'state_id', 'phone', 'image', 'website', 'status', 'remember_token', 'apply_vender', 'gender', 'is_verified','google2fa_enable','google2fa_secret'
    ];
