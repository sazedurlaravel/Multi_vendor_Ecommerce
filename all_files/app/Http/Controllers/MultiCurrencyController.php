...
class MultiCurrencyController extends Controller
{
    ...
    {   
        $currencies = CurrencyNew::join('multi_currencies','currencies.id','=','multi_currencies.currency_id')
                      ->select('currencies.id as id','currencies.code as code','currencies.exchange_rate as rate','currencies.updated_at as updated_at','multi_currencies.currency_symbol as symbol','multi_currencies.add_amount as additonalAmount','multi_currencies.default_currency as default','multi_currencies.id as mid','multi_currencies.position as position');
